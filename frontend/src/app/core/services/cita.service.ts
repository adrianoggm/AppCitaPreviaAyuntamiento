...
export class CitaService {
  ...
  private apiUrl2 = `${environment.apiUrl}/cita/horas-disponibles`;
  ...
  getHorasDisponibles(tipoTramite: string): Observable<string[]> {
    return this.http.get<string[]>(`${this.apiUrl2}?tipoTramite=${tipoTramite}`);
  }
}
