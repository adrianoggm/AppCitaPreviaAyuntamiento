...
export class CreateDepartamentoUseCase {
    ...
    async execute (CreateDepartamentoDto: CreateDepartamentoDto) : Promise<Departamento> {
       // console.log("LLEEEGAAAAA ",CreateUsuarioDto);
        return this.departamentoRepository.createDepartamento(CreateDepartamentoDto);
    }
