// src/application/use-cases/get-nombre-tramites-tipotramites.use-case.ts
...
export class GetNombreTramitesTipoTramitesUseCase {
   ...
   *
   * @returns {Promise<{ [nombreTramite: string]: string }>} Mapa de nombretramite => nombretipotramite.
   */
